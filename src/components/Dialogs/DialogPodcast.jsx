            ...
            <Dialog open={open}  sx={{ width: 500, marginLeft: 70, borderRadius: 4 }} >
                ...
                <DialogContent>
                    ...
                    <FormControl fullWidth sx={{marginTop:1,marginBottom:2}}>
                        <InputLabel id="demo-simple-select-label" color="fifth">Categoria</InputLabel>
                        <Select
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-label" color="fifth">Año</InputLabel>
                        <Select
                            labelId="demo-simple-select-label"
                            id="demo-simple-select"
                    ...
                    <Input type="file" multiple accept=".mp3,.mp4,audio/*" color="fifth" sx={{marginTop:2,width: 388}}/>
